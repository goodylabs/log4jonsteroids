package com.goodylabs.utils.logging;
...
/**
 * RotatingDailyRollingFileAppender is based on
 * {@link org.apache.log4j.appender.DailyRollingFileAppender}.
 */
public class RotatingDailyRollingFileAppender extends FileAppender
{
	 ...
	 */
	public RotatingDailyRollingFileAppender()
	{
	}

	/**
	 * Instantiate a RotatingDailyRollingFileAppender and open the file
	 * designated by filename. The opened filename will become the ouput
	 * destination for this appender.
	 */
	public RotatingDailyRollingFileAppender(Layout layout, String filename,
...
class RollingCalendar extends GregorianCalendar
{
	...
	int type = RotatingDailyRollingFileAppender.TOP_OF_TROUBLE;
	...
	public Date getNextCheckDate(Date now)
	{
		...
		switch (type)
		{
		case RotatingDailyRollingFileAppender.TOP_OF_MINUTE:
			this.set(Calendar.SECOND, 0);
			this.set(Calendar.MILLISECOND, 0);
			this.add(Calendar.MINUTE, 1);
			break;
		case RotatingDailyRollingFileAppender.TOP_OF_HOUR:
			this.set(Calendar.MINUTE, 0);
			this.set(Calendar.SECOND, 0);
			this.set(Calendar.MILLISECOND, 0);
			this.add(Calendar.HOUR_OF_DAY, 1);
			break;
		case RotatingDailyRollingFileAppender.HALF_DAY:
			this.set(Calendar.MINUTE, 0);
			this.set(Calendar.SECOND, 0);
			this.set(Calendar.MILLISECOND, 0);
			...
			break;
		case RotatingDailyRollingFileAppender.TOP_OF_DAY:
			this.set(Calendar.HOUR_OF_DAY, 0);
			this.set(Calendar.MINUTE, 0);
			this.set(Calendar.SECOND, 0);
			this.set(Calendar.MILLISECOND, 0);
			...
			break;
		case RotatingDailyRollingFileAppender.TOP_OF_WEEK:
			...
			break;
		case RotatingDailyRollingFileAppender.TOP_OF_MONTH:
